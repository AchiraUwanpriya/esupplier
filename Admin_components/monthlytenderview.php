...
$tenders = getTenders($con, $mtd_type);
?>
...
$supcodevalue;
if (empty($tenders)) {
	echo '<div class="alert alert-warning text-center">No monthly tenders found.</div>';
}
// ...existing monthly tender rendering code from original monthlytenderview.php...
?>