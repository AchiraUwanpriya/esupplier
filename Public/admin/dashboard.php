...
require_once(__DIR__ . '/../../backend/admin/dashboard-queries.php');
require_once(__DIR__ . '/../../backend/admin/dashboard-handler.php');
...
<head>
	...
	<!-- Bootstrap 5 bundle (includes Popper) required for data-bs-* modals -->
				...
				<div class="modal-body">
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                      ...
                      <?php if ($user_category === 'RI'): ?>
						...
						<!-- //pvc -->
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-pvc" type="button" role="tab" aria-controls="pills-pvc" aria-selected="false">PVC Items</button>
						</li>
						<?php endif; ?>
						...
						<!-- //medicine -->
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-medicine" type="button" role="tab" aria-controls="pills-medicine" aria-selected="false">Medicine Items</button>
						</li>
						<?php endif; ?>
						...
						<!-- //cable -->
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-cable" type="button" role="tab" aria-controls="pills-cable" aria-selected="false">Cables</button>
						</li>
						<?php endif; ?>
					...
					<div class="tab-content" id="pills-tabContent">
						...
						<!-- //pvc -->
						<div class="tab-pane fade" id="pills-pvc" role="tabpanel" aria-labelledby="pills-pvc-tab">
							<form id="" method="post">
								<table class="table table-hover table-bordered border-primary">
									<thead>
										<tr class="fixed">
						...
						<!-- //cables -->
						<div class="tab-pane fade" id="pills-cable" role="tabpanel" aria-labelledby="pills-cable-tab">
							<form id="" method="post">
								<table class="table table-hover table-bordered border-primary">
									<thead>
										<tr class="fixed">
							...
							<div class="col-12 col-sm-10 col-md-10 col-lg-6 col-xl-12 p-0 mt-3 mb-2">
								<div class="card px-0 pb-0">
									...
									<!-- <h3 id="" class="text-center" style="color: blue;"><strong>Tender For the Supply of Foods - Cash Price</strong></h3> -->
									  <h3 id="" class="text-center" style="color: blue;">
									<strong>
										 <?php 
									...
									<!--<h2 class="pt-4">à·€à¶»à·Šà¶œà¶º à¶­à·à¶»à· à¶‰à¶¯à·’à¶»à·’à¶ºà¶§ à¶ºà¶±à·Šà¶±</h2>-->
							...
							<div class="modal-body">
								<form id="veg" action="dashboard.php?stage=2" method="POST">
									...
									<table class="table table-hover">
										...
										<?php
										$suppliercode = $_SESSION['sup_code'];
										$userCat = $user_category;
										$tender = getTenderByCategory($con, $userCat);
										$tenderNo = $tender['tenderNo'] ?? '';
										$stmt = getMaterialsByCategory($con, 'V', $suppliercode, $tenderNo);
										...
										?>
											<tr>
												<td><?php echo htmlspecialchars($row['MMC_DESCRIPTION']); ?> <input type="text" hidden name="MMC_DESCRIPTION[<?= $index ?>]" value="<?php echo htmlspecialchars($row['MMC_DESCRIPTION']); ?>"></td>
												<td><?php echo htmlspecialchars($row['MMC_MATERIAL_SPEC']); ?><input type="text" hidden name="MMC_MATERIAL_SPEC[<?= $index ?>]" value="<?php echo htmlspecialchars($row['MMC_MATERIAL_SPEC']); ?>"></td>
												<td><?php echo htmlspecialchars($row['MMC_UNIT']); ?><input type="text" hidden name="MMC_UNIT[<?= $index ?>]" value="<?php echo htmlspecialchars($row['MMC_UNIT']); ?>"></td>
												<td>
													<input class="form-control" style="max-width:100%; text-align: right;" type="text" name="MMC_REMARK[<?= $index ?>]" id="MMC_REMARK[<?= $index ?>]" value="<?= htmlspecialchars($row['MMC_REMARK'] ?? ''); ?>" placeholder="Remark" />
												</td>
												<td>
													<input class="form-control" style="max-width:100%; text-align: right;" type="number" step="0.01" name="MMC_PRICE[<?= $index ?>]" id="MMC_PRICE[<?= $index ?>]" value="<?= htmlspecialchars($row['MMC_PRICE'] ?? ''); ?>" placeholder="Price" />
												</td>

												<td style="display:none"><?php echo htmlspecialchars($row['MMC_MATERIAL_CODE']); ?> <input type="text" hidden name="MMC_MATERIAL_CODE[<?= $index ?>]" value="<?php echo htmlspecialchars($row['MMC_MATERIAL_CODE']); ?>"></td>
												<td style="display:none"><?php echo htmlspecialchars($row['MMC_CAT_CODE']); ?> <input type="text" hidden name="MMC_CAT_CODE[<?= $index ?>]" value="<?php echo htmlspecialchars($row['MMC_CAT_CODE']); ?>"></td>
					...
					<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
						<div class="modal-content">
							<div class="modal-header">
								...
								<img src="./img/gift-wrapping.png" style="width: 80px;" alt="">
...
<?php endif; ?>
  ...
  <?php if ($user_category === 'PI'): ?>
				<!-- Modal PVC Items Papers -->
				<div class="modal fade" id="pvcModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
					<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
						<div class="modal-content">
							<div class="modal-header">
							...
							<br>
							<center>
								<h3 class="text-success" id="lb12">
							</center>
							<div class="modal-body">
								<b>
									<h2 id="mealAddMsg" style="color: green;" class="text-success"></h2>
								</b>
								<form id="pvc" method="POST" action="dashboard.php?stage=2">
									<table class="table table-hover">
										<tr class="fixed">
											<th class="bg-success">
												<h3 class="fw-bold">Item Name</h3>
											...
											<th class="bg-success">
												<h3 class="fw-bold">Unit: MTS/NOS</h3 class="fw-bold">
											</th>
											<th class="bg-success">
												<h3 class="fw-bold">Remarks</h3>
											</th>
										...
										$tsql = "SELECT MMC_DESCRIPTION,MMC_BALANCE_QTY,MMC_STOCK_CATEGORY, MMC_BIN_LOCATION,MMC_UNIT, MMC_MATERIAL_SPEC, MMC_MATERIAL_CODE ,MMC_CAT_CODE,mms_tenderprice_transactions.mtt_price AS MMC_PRICE,mms_tenderprice_transactions.mtt_remark AS MMC_REMARK
										FROM mms_material_catalogue
										LEFT JOIN mms_tenderprice_transactions ON mms_tenderprice_transactions.mtt_material_code = mms_material_catalogue.MMC_MATERIAL_CODE 
										AND mtt_supplier_code = '$suppliercode'
							...
							<div class="modal-footer">
								<input type="hidden" name="insert" value="pvcs" />
								<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
								<button type="submit" class="btn btn-success item-savebtn" onclick="changeTxt12()">
									Save
								</button>
								<!-- <button type="submit" class="btn btn-primary" name="insert" value="spices">Save changes</button> -->
							</div>
     ...
     <?php endif; ?>
				...
				<!-- Modal Medicine Items  -->

			<!-- <?php if ($user_category === 'MI'): ?>
				<div class="modal fade" id="medicineModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
					<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
						<div class="modal-content">
			     		<form id="medicine" method="POST" action="dashboard.php?stage=2">
							...
							<div class="modal-footer">
								<input type="hidden" name="insert" value="med" />
								<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
								<button type="submit" class="btn btn-success item-savebtn" onclick="changeTxt13()">
									Save
								</button>
							</div>
					    </form>
	 ...
	 <?php if ($user_category === 'MI'): ?>
                <div class="modal fade" id="medicineModal" tabindex="-1" role="dialog" aria-labelledby="medicineModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <form id="medicine" method="POST" action="dashboard.php?stage=2">
                                <div class="modal-header">
                                    <h2 class="modal-title text-info" id="medicineModalLabel">MEDICINE ITEMS&nbsp;&nbsp;</h2>
                                    <img src="./static/img/medicine.png" style="width: 80px;" alt="">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>

                                <!-- explicit scroll container with limited height to ensure scrolling works -->
                                <div class="modal-body" style="max-height: calc(100vh - 220px); overflow-y: auto;">
                                    <center><h3 class="text-success" id="lb13"></h3></center>
                                    <b><h2 id="mealAddMsg" style="color: green;" class="text-success"></h2></b>

                                    <table class="table table-hover">
                                        <thead>
                                            <tr class="fixed">
                                                <th class="bg-success"><h3 class="fw-bold">Item Name</h3></th>
                                                <th class="bg-success"><h3 class="fw-bold">Description</h3></th>
                                                <th class="bg-success"><h3 class="fw-bold">Unit: MTS/NOS</h3></th>
                                                <th class="bg-success"><h3 class="fw-bold">Remarks</h3></th>
                                                <th class="bg-success"><h3 class="fw-bold">Tender Price (Rs.)</h3></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        ...
                                        $tsql = "SELECT MMC_DESCRIPTION,MMC_BALANCE_QTY,MMC_STOCK_CATEGORY, MMC_BIN_LOCATION,MMC_UNIT, MMC_MATERIAL_SPEC, MMC_MATERIAL_CODE ,MMC_CAT_CODE,
                                        ...
                                        $stmt = mysqli_query($con, $tsql);
                                        if ($stmt === false) {
                                            echo '<tr><td colspan="5">Error loading items.</td></tr>';
                                        } else {
                                            $index = 0;
                                            while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC)) {
                                        ?>
                                                <tr>
                                                    <td>
                                                        <?= htmlspecialchars($row['MMC_DESCRIPTION']); ?>
                                                        <input type="hidden" name="MMC_DESCRIPTION[<?= $index ?>]" value="<?= htmlspecialchars($row['MMC_DESCRIPTION']); ?>">
                                                    </td>
                                                    <td>
                                                        <?= htmlspecialchars($row['MMC_MATERIAL_SPEC']); ?>
                                                        <input type="hidden" name="MMC_MATERIAL_SPEC[<?= $index ?>]" value="<?= htmlspecialchars($row['MMC_MATERIAL_SPEC']); ?>">
                                                    </td>
                                                    <td>
                                                        <?= htmlspecialchars($row['MMC_UNIT']); ?>
                                                        <input type="hidden" name="MMC_UNIT[<?= $index ?>]" value="<?= htmlspecialchars($row['MMC_UNIT']); ?>">
                                                    </td>
                                                    <td>
                                                        <input class="form-control" style="max-width:100%; text-align: right;" type="text" name="MMC_REMARK[<?= $index ?>]" id="MMC_REMARK_<?= $index ?>" value="<?= htmlspecialchars($row['MMC_REMARK']); ?>" placeholder="Remark" />
                                                    </td>
                                                    <td>
                                                        <input class="form-control" style="max-width:100%; text-align: right;" type="number" step="0.01" name="MMC_PRICE[<?= $index ?>]" id="MMC_PRICE_<?= $index ?>" value="<?= htmlspecialchars($row['MMC_PRICE']); ?>" placeholder="Price" />
                                                    </td>

                                                    <td style="display:none">
                                                        <input type="hidden" name="MMC_MATERIAL_CODE[<?= $index ?>]" value="<?= htmlspecialchars($row['MMC_MATERIAL_CODE']); ?>">
                                                        <input type="hidden" name="MMC_CAT_CODE[<?= $index ?>]" value="<?= htmlspecialchars($row['MMC_CAT_CODE']); ?>">
                                                    </td>
                                                </tr>
                                            <?php
                                                $index++;
                                ...
                                <div class="modal-footer">
                                    <input type="hidden" name="insert" value="med" />
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <button type="submit" class="btn btn-success item-savebtn" onclick="changeTxt13()">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
		 ...
		 <?php if ($user_category === 'CB'): ?>
				<div class="modal fade" id="cableModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
					<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
						<div class="modal-content">
							<div class="modal-header">
							...
							<br>
							<center>
								<h3 class="text-success" id="lb14">
							</center>
							<div class="modal-body">
								<b>
									<h2 id="mealAddMsg" style="color: green;" class="text-success"></h2>
								</b>
								<form id="cable" method="POST" action="dashboard.php?stage=2">
									<table class="table table-hover">
										<tr class="fixed">
											<th class="bg-success">
												<h3 class="fw-bold">Item Name</h3>
							...
							<div class="modal-footer">
								<input type="hidden" name="insert" value="cab" />
								<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
								<button type="submit" class="btn btn-success item-savebtn" onclick="changeTxt14()">
									Save
								</button>
								<!-- <button type="submit" class="btn btn-primary" name="insert" value="spices">Save changes</button> -->
							</div>
...
<script>
	...
	function changeTxt12() {

		var element = document.getElementById("lb12");
		element.innerHTML = "Data Saved Succesfully";
		setTimeout(clearValue, 1500);
	...
	function changeTxt13() {

		var element = document.getElementById("lb13");
		element.innerHTML = "Data Saved Succesfully";
		setTimeout(clearValue, 1500);
		...
		function changeTxt14() {

		var element = document.getElementById("lb14");
		element.innerHTML = "Data Saved Succesfully";
		setTimeout(clearValue, 1500);
...
<script>
	$(document).ready(function() {
		$("#pvc").submit(function(event) {
			var formData = $("#pvc").serialize();
			//   var formData = {
			//     name: 'abc',
			//     email: 'abcd',
			//   };
...
<script>
	$(document).ready(function() {
		$("#medicine").submit(function(event) {
			var formData = $("#medicine").serialize();
			//   var formData = {
			//     name: 'abc',
			//     email: 'abcd',
			//   };
...
<script>
	$(document).ready(function() {
		$("#cable").submit(function(event) {
			var formData = $("#cable").serialize();
			//   var formData = {
			//     name: 'abc',
			//     email: 'abcd',
			//   };
