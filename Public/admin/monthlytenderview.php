<?php include_once __DIR__ . '/../../backend/monthlytenderview_controller.php'; ?>
<!DOCTYPE html>
<html lang="en">
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<a href="logoutadmin.php" class="dropdown-item" onclick="return confirm('Please Confirm To Logout!!')">Logout</a>
							</div>
						</li>
					</ul>
				</div>
