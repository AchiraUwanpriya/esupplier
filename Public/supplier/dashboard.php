...
// Include backend queries
require_once(__DIR__ . '/../../backend/supplier/dashboard-queries.php');
							...
							<div class="modal-body">
								<form id="veg" action="dashboard.php?stage=2" method="POST">
									...
									<table class="table table-hover">
										...
										<?php
										$suppliercode = $_SESSION['sup_code'];
										$stmt = getMaterialsByCategory($con, 'V', $suppliercode, 'vegetables', $user_category);
										...
										?>
											<tr>
												...
												<td style="display:none"><input type="text" hidden name="MMC_MATERIAL_CODE[<?= $index ?>]" value="<?php echo htmlspecialchars($row['MMC_MATERIAL_CODE']); ?>"></td>
												<td style="display:none"><input type="text" hidden name="MMC_CAT_CODE[<?= $index ?>]" value="<?php echo htmlspecialchars($row['MMC_CAT_CODE']); ?>"></td>
											</tr>
										<?php
											$index++;
										}
							...
							<div class="modal-body">
								...
								<form id="spices" method="POST" action="dashboard.php?stage=2">
									<table class="table table-hover">
										...
										<?php
										$suppliercode = $_SESSION['sup_code'];
										$stmt = getMaterialsByCategory($con, 'S', $suppliercode, 'spices', $user_category);
							...
							<div class="modal-body">
								<form id="fish" method="POST" action="dashboard.php?stage=2">
									<table class="table table-hover">
										...
										<?php
										$suppliercode = $_SESSION['sup_code'];
										$stmt = getMaterialsByCategory($con, 'F', $suppliercode, 'fish', $user_category);
							...
							<div class="modal-body">
								<form id="dfish" method="POST" action="dashboard.php?stage=2">
									<table class="table table-hover">
										...
										<?php
										$suppliercode = $_SESSION['sup_code'];
										$stmt = getMaterialsByCategory($con, 'D', $suppliercode, 'dfish', $user_category);
