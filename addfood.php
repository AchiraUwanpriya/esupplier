...
<body>
	...
	<div class="modal fade" id="pvcItemsModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<input type="hidden" name="insert" value="pvcItm" />
	...
	<!-- Start Modal medicine items -->
	<div class="modal fade" id="medItemsModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-footer">
					<input type="hidden" name="insert" value="medItm" />
					<a href="" data-bs-toggle="modal" data-bs-target="#medItemsAddModal">
						<button type="button" class="btn btn-primary">Add</button>
					</a>
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
					<!-- <button type="submit" class="btn btn-success">
	...
	<!-- Add new, modal -->
	<div class="modal fade" id="medItemsAddModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
	...
	<div class="modal fade" id="cablesModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<input type="hidden" name="insert" value="cable" />
					<a href="" data-bs-toggle="modal" data-bs-target="#cableAddModal">
						<button type="button" class="btn btn-primary">Add</button>
					</a>
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
					<!-- <button type="submit" class="btn btn-success">
	...
	<!-- Add new, modal -->
	<div class="modal fade" id="cableAddModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
...
<script>
	$(document).ready(function() {
		$("#pvcItm").submit(function(event) {
			var formData = $("#pvcItm").serialize();
			//   var formData = {
			//     name: 'abc',
			//     email: 'abcd',
			//   };
...
<script>
	$(document).ready(function() {
		$("#medItm").submit(function(event) {
			var formData = $("#medItm").serialize();
			//   var formData = {
			//     name: 'abc',
			//     email: 'abcd',
			//   };
