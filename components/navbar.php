...
<head>
    ...
    <link href="<?= $sbase ?>static/css/translate.css" rel="stylesheet" />
</head>
...
<body>
            ...
            <ul class="navbar-nav navbar-align">
                ...
                <li class="nav-item dropdown">
                    <a id="profileDropdownToggle" class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?= $sbase ?>static/img/avatars/avatar1.jpg" class="avatar img-fluid rounded me-1" alt="" />
                        <span class="text-dark"><?php echo $_SESSION['sup_name'] ?></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="<?= $sbase ?>profile.php"><i class="align-middle me-1" data-feather="user"></i>
                            Profile</a>
    ...
    <script>
        ...
        function GTranslateFireEvent(element, event) {
            try {
                if (document.createEventObject) { var evt = document.createEventObject(); element.fireEvent("on" + event, evt); }
